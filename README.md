# Laravel Web Installer | A Web Installer [Package](https://packagist.org/packages/triptasoft/laravel-installer)

[![Total Downloads](https://poser.pugx.org/triptasoft/laravel-installer/d/total.svg)](https://packagist.org/packages/triptasoft/laravel-installer)
[![Latest Stable Version](https://poser.pugx.org/triptasoft/laravel-installer/v/stable.svg)](https://packagist.org/packages/triptasoft/laravel-installer)
[![License](https://poser.pugx.org/triptasoft/laravel-installer/license.svg)](https://packagist.org/packages/triptasoft/laravel-installer)
...
```bash
    composer require triptasoft/laravel-installer
```
...
```php
	'providers' => [
	    Triptasoft\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
	];
```
...
* If you have any suggestions please let me know : https://github.com/Triptasoft/LaravelInstaller/pulls.
* Please help us provide more languages for this awesome package please send a pull request https://github.com/Triptasoft/LaravelInstaller/pulls.
